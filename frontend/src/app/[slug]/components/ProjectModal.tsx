                    ...
                    >
                            ...
                            {images.length > 0 ? (
                                <>
                                    <div className="relative w-full h-full">
                                        ...
                                        <motion.div 
                                            variants={contentVariants}
                                            className="absolute inset-0 flex items-center justify-between p-4 opacity-100 md:opacity-0 md:hover:opacity-100 transition-opacity duration-300"
                                        >
                                            <button
                        ...
                        <div className="w-full md:w-1/3 flex-1 md:flex-none p-6 md:p-12 overflow-y-auto custom-scrollbar border-t md:border-t-0 md:border-l border-white/10 bg-gradient-to-b from-[#111] to-[#0a0a0a]">
                            <div className="space-y-6">
                                ...
                                <motion.div variants={contentVariants} className="w-12 h-0.5 bg-amber-500/50" />
                                <motion.p variants={contentVariants} className="text-gray-300 font-light leading-relaxed whitespace-pre-wrap text-sm md:text-base">
                                    {config.description}
                                </motion.p>
                            </div>
                        </div>
